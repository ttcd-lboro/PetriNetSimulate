...
%% Define simulation
Sim.SimTitle = 'subnetsPhasedMission_real';
...
Sim.CaseDataMatName = 'CaseData-subnetsPhasedMission'; % run 'additionalTools/exampleBuildMatricesFromExcel.m' first to generate an example
