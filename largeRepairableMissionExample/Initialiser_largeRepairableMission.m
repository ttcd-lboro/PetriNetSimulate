...
%% Define simulation
Sim.SimTitle = 'largeRepairableMission';
Sim.PhaseDurations = [10]; % Duration of each phase specified in in units matching those of the failure data)
...
Sim.CaseDataMatName = 'CaseData-largeRepairableMission';
