...
%% Code: Do not modify %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load(['../',InputConnectivityMatName,'.mat'],'A','ASubnet'); % read in A matrices for all phases with their associated (glboal) place and transition IDs.
addpath('../')
...
load(['../',InputConnectivityMatName,'.mat'],'AGlobal')
